...
PING_CONTENT = bytes(
    [13, 30, 235, 84, 79, 26, 41, 243, 148, 64, 23, 16, 175, 162, 223, 88]
)

PROXY = None
TARGET = (
    "https://maimai-gm.wahlap.com:42081/Maimai2Servlet/5c39ae037195be3f0f9a8e8f6f8ec849"
)
INTERVAL = 1  # 请求间隔（秒）
...
file_handler = logging.FileHandler(
    f"logs/舞萌DX_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log",
    encoding="utf-8",
)
...
async def do_request():
    ...
    try:
        ...
        resp = await client.post(
            ...
            headers={
                "user-agent": "5c39ae037195be3f0f9a8e8f6f8ec849#",
                "Mai-Encoding": "1.53",
                "accept": "*/*",
                "accept-encoding": "",
                "Charset": "UTF-8",
